...
function gen_tfrecord()
{
     ...
     python util/make_tfrecord_parallel.py \
         --anno_folder='./data/voc/train/VOCdevkit/VOC2007_2012/Annotations/' \
         --image_folder='./data/voc/train/VOCdevkit/VOC2007_2012/JPEGImages/' \
         --name_file='./data/voc/train/VOCdevkit/VOC2007_2012/ImageSets/Main/trainval.txt' \
